    ...
    <div style={{ perspective: 2000 }}>
      ...
      <motion.div
        ...
        <p className='max-w-[300px] text-[#000000] mb-6'>
          Taking the classic look of heritage Nike Running into new realm, the Nike Air Max Pre-Day brings you
          a fast-paced look that's ready for today's world.
        </p>
        {/* btn & price wrapper */}
          ...
          {colors.map((color, index) => {
            return (
              <li
                ...
                className='w-8 h-8 rounded-full cursor-pointer'></li>
            )
          })}
        </ul>
        {/* card image */}
